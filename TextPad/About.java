...
public class About extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Heading.setText("Text Pad");

        Logo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TextPad/icon.png"))); // NOI18N
        Logo.setPreferredSize(new java.awt.Dimension(50, 50));

        aboutArea.setEditable(false);
        aboutArea.setBackground(new java.awt.Color(240, 240, 240));
        aboutArea.setColumns(20);
        aboutArea.setRows(5);
        aboutArea.setText("Version 1.0 \n©2017 SuperMan® Productions\nAll rights reserved.\nContact the author-\nsakshambhardwaj002@gmail.com");
