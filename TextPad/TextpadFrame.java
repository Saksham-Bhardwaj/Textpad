...
/* GLOBAL VARIABLES FOR EDITING RELATED WORK*/
    ...
    private void textAreaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textAreaKeyTyped
        ...
        try
        {
            ...
            col = caretpos - textArea.getLineStartOffset(row);
        }
        catch(Exception e)
        {
        ...
        Col.setText("Col: "+Integer.toString(col));
        
        
        Line.setText("Line: "+Integer.toString(row));
    ...
    private void RedoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RedoActionPerformed
        try {
          undoManager.redo();
            ...
            JOptionPane.showMessageDialog(this, cre.getMessage());
        }
